    ...
    _Exporter.prototype.createNodeMapAndAnimationsAsync = function (babylonScene, nodes, shouldExportNode, binaryWriter) {
                    ...
                    return _this.createNodeAsync(babylonNode, binaryWriter).then(function (node) {
                        ...
                        if (promise == null) {
                            ...
                            return promise.then(function (node) {
                                var directDescendents = babylonNode.getDescendants(true, function (node) { return (node instanceof Node); });
                                ...
                                if (!babylonScene.animationGroups.length && babylonNode.animations.length) {
                                    _GLTFAnimation._CreateNodeAnimationFromNodeAnimations(babylonNode, runtimeGLTFAnimation, idleGLTFAnimations, nodeMap, _this._nodes, binaryWriter, _this._bufferViews, _this._accessors, _this._convertToRightHandedSystem, _this._animationSampleRate);
                                }
                            });
                        }
                    });
        ...
        return promiseChain.then(function () {
            ...
            if (babylonScene.animationGroups.length) {
                _GLTFAnimation._CreateNodeAnimationFromAnimationGroups(babylonScene, _this._animations, nodeMap, _this._nodes, binaryWriter, _this._bufferViews, _this._accessors, _this._convertToRightHandedSystem, _this._animationSampleRate);
            }
            return nodeMap;
        });
    };
